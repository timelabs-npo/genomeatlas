...
GenomeOps retention belongs in the private `timelabs-npo/ai-traces` repository on `dedends`; the retired public duplicate is no longer a second source. See the [RFC index](docs/rfcs/README.md), [maintenance guide](docs/maintenance.md), [integration details](docs/genomeops-integration.md), [historical suite README](docs/history/site-helper-readme-before-fusion.md), [LICENSE](LICENSE) and [third-party notices](THIRD_PARTY_NOTICES.md).
