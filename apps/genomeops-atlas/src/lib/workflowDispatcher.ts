...
export function workflowPrompt(workflow: AvailableWorkflow, request: ReturnType<typeof workflowPayload>) {
  ...
  return [
    ...
    'SCOPE: Bounded request; use only the exact versioned accessions in the request below. Never expand beyond three genomes.',
    ...
    'File contents are not transferred by this brief. Attach the original inputs in the execution workspace.',
    '',
    'CONSTRAINTS:',
