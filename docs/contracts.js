...
(function (root) {
  ...
  function scientificState(record) {
    ...
    if (record.call === "C") return record.complete_cassette === true && record.exact_strain_evidence === true && typeof record.evidence_reference === "string" && record.evidence_reference.trim() ? "C" : "U";
